...
(function() {
  ...
  // Detect whether we're on a touch screen device
  VS.isTouchDevice = 'ontouchstart' in window;
...
VS.ui.SearchBox = Backbone.View.extend({
  ...
  events : (function() {
    ...
    // Detect touch-screen devises and apply a different
    // event listener for those. This fixes the problem
    // with the search box not being focusable in iOS.
    if (VS.isTouchDevice) {
      events['mouseup .VS-search-box'] = 'maybeFocusSearch';
    } else {
      events['mousedown .VS-search-box'] = 'maybeFocusSearch';
    }
  ...
  addedFacet : function (model) {
    ...
    if (VS.isTouchDevice) {
      ...
      _.defer(function() { facetView.enableEdit(); });
    }
  },
...
(function($) {
  ...
  $.widget("ui.VSautocomplete", $.extend({}, $.ui.autocomplete.prototype, {
    _init: function() {
      this.element.data('ui-autocomplete', this.element.data('ui-VSautocomplete'));
